                ...
                <div class="content-grid-effect slow-zoom vertical">
                    ...
                    <div class="info-box">
                        <div class="info-content simpleCart_shelfItem">
                            ...
                            <p><span class="item_price">300 000 VND</span></p>
                            <span class="separator"></span>
                            <a class="item__add hvr-outline-out button2" href="#"> Xem chi tiết</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 content-img-right">
                <h3>Khuyến Mãi Đặc Biệt <span>Giảm Giá 50%</span> MẮT KÍNH</h3>
            </div>

            <div class="col-sm-6 content-img-right">
                <h3>Mua 1 tặng 1 <span>với</span> GIÀY BẢO HỘ</h3>
            </div>
            <div class="col-sm-6 content-img-left text-center">
                <div class="content-grid-effect slow-zoom vertical">
                    ...
                    <div class="info-box">
                        <div class="info-content simpleCart_shelfItem">
                            <h4>Giày</h4>
                            <span class="separator"></span>
                            <p><span class="item_price">450 000 VND</span></p>
                            <span class="separator"></span>
                            <a class="item__add hvr-outline-out button2" href="#"> Xem chi tiết</a>
                        </div>
                    </div>
            ...
            <div class="content-grid-effect slow-zoom vertical">
                ...
                <div class="info-box">
                    <div class="info-content simpleCart_shelfItem">
                        <h4>GĂNG TAY</h4>
                        <span class="separator"></span>
                        <p><span class="item_price">200 000 VND</span></p>
                        <span class="separator"></span>
                        <a class="item__add hvr-outline-out button2" href="#">Xem chi tiết </a>
                    </div>
                </div>
            ...
            <div class="sap_tabs">
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                    <ul class="resp-tabs-list">
                        <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>SẢN PHẨM MỚI RA MẮT</span></li>
                    </ul>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="item-info-product">
                                        ...
                                        <a class="item_add single-item hvr-outline-out button2">Thêm Vào Giỏ Hàng
                                        </a>
                                    </div>
                                        </div>
                                    </div>
            ...
            <div class="footer">
                <div class="container">
                    <div class="col-md-3 footer-left">
                        ...
                        <p>Dynamic Limitless Defense không những mang lại cho người dùng một thương hiệu uy tín mà còn mang ý nghĩa thể hiện tính bảo hộ năng động trong nhiều trường hợp, giúp cho người dùng an tâm khi dùng nó và cũng mang tính chất lượng
                            cao của sản phẩm.</p>
                    </div>
